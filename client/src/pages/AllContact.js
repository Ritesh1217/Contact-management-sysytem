...
const AllContact = () => {
  ...
  useEffect(async () => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8000/api/mycontacts?page=${currentPage}`, // Include the current page in the request
        {
          method: "GET",
          headers: {
  ...
  }, [currentPage]); // Trigger the effect when the currentPage changes
              ...
              <>
                ...
                <div className="pagination">
                  ...
                  <button
                    ...
                    disabled={contacts.length < 4} // Disable if there are no more contacts
                  >
                    Next
                  </button>
                </div>
